...
const KNOWN_DEFAULTS: Record<string, AdapterCapabilities> = {
  ...
  http: { supportsInstructionsBundle: true, supportsSkills: false, supportsLocalAgentJwt: false, requiresMaterializedRuntimeSkills: false, supportsModelProfiles: false },
};
